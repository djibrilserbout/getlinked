                                ...
                                <form onSubmit={handleSubmit}>
                                    <div className="mb-4">
                                        ...
                                        <input
                                            ...
                                            name="formBasicCompany" defaultValue={experience.companyName} id="companyname" type="text" placeholder="ex: Capgemini"/>
                                    </div>
                                    <div className="mb-4">
                                        <label className="block text-gray-700 text-sm font-bold mb-2"
                                        ...
                                        <input
                                            className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                            name="formBasicTitle" defaultValue={experience.name} id="jobtitle" type="text" placeholder="ex: Développeur backend Symfony"/>
                                    </div>
                                    <div className="mb-4">
                                        <label className="block text-gray-700 text-sm font-bold mb-2"
                                        ...
                                        <input
                                            className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                            name="formBasicDateBegin" defaultValue={experience.dateBegin} id="datebegincompany" type="date" />
                                    </div>
                                    <div className="mb-4">
                                        <label className="block text-gray-700 text-sm font-bold mb-2"
                                        ...
                                        <input
                                            className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                            name="formBasicDateFinish" defaultValue={experience.dateFinish} id="datefinishcompany" type="date" />
                                    </div>
                                    <div className="mb-4">
                                        <label className="block text-gray-700 text-sm font-bold mb-2"
                                        ...
                                        <textarea
                                            className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                            name="formBasicDescription" defaultValue={experience.description} id="description"  placeholder="ex: J'ai pu apprendre de nouvelles choses sur..."/>
                                    </div>
                                    <div className="mt-4">
                                        <button
                                            type="submit"
