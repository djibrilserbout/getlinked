...
const navigation = [
    ...
    { name: 'Profils développeurs', href: '/user', current: false },
                    ...
                    <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
                        <div className="relative flex h-16 items-center justify-between">
                            ...
                            <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                                <div className="company-name flex flex-shrink-0 items-center text-white text-2xl font-bold">
                                    <Image src={"/getlinked-logo-transparent.png"} unoptimized height={"25px"} width={"96px"}/>
                                </div>
