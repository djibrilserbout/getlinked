                                ...
                                <form onSubmit={handleSubmit}>
                                    <div className="mb-4">
                                        ...
                                        <input
                                            ...
                                            name="formStepName" defaultValue={step.name} id="stepname" type="text" placeholder="ex: Créer une architecture HTML"/>
                                    </div>
                                    <div className="mb-4">
                                        <label className="block text-gray-700 text-sm font-bold mb-2"
                                        ...
                                        <textarea
                                            className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                            name="formStepDescription" defaultValue={step.description} id="stepdescription" placeholder="ex: Commencer par comprendre comment fonctionne HTML"/>
                                    </div>
                                    <div className="mt-4">
                                        <button
                                            type="submit"
